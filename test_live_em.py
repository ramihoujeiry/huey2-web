...
with sync_playwright() as p:
    ...
    pg.wait_for_selector("section:has-text('SQN XII SOP') .list-btn", timeout=5000)
    check('sop buttons', pg.locator("section:has-text('SQN XII SOP') .list-btn").count()>5, True)
